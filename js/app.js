/*$(document).ready(function() {	
    ...
    $('.btn-reinicio').on('click', function(){
        ...
        $('#timer').timer({
            duration: '5s',
            callback: function() {
                alert('!! 2 minutos!! Tiempo agotado..!');
...
$(document).ready(function() {
    ...
    var intervalID = window.setInterval(miFuncion, 2500);
    function miFuncion() {
        $(".main-titulo" ).animate({
            color: "#fff",
        }, 200)
...
//interacción del usuario con el elemento caramelo es drag and drop efecto de movimiento entre los caramelos
